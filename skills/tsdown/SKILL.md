...
> For comprehensive migration assistance with complete option mappings, install the dedicated [`tsdown-migrate`](https://github.com/rolldown/tsdown/blob/main/skills/tsdown-migrate/SKILL.md) skill: `npx skills add rolldown/tsdown --skill tsdown-migrate`
